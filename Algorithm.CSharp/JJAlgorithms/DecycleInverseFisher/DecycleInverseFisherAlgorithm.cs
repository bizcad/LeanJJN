...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class DecycleInverseFisherAlgorithm : QCAlgorithm
    {
        ...
        private DateTime _endDate = new DateTime(2015, 06, 30);
        private decimal _portfolioAmount = 26000 * 4;
     ...
     * +-------------------------------------------------+*/
        ...
        private bool noOvernight = false;                 // Close all positions before market close.
        /* +-------------------------------------------------+*/
